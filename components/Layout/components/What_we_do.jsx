...
adding activities</p>
          ...
          <div className="col-lg-6">
            <div className="choose-content">
              ...
              <p>
                ...
                Following gies heur portfolio includes dozen.
              </p>
    ...
    {/* counter-area-end */}
    {/* project-area */}
    <section id='what' className="project-area">
      <div className="container">
              ...
              <div className="project-item">
                ...
                <div className="project-content">
                  <div className="left-side-content">
                    ...
                    <span>Analyse business, outline
strategic plan and assist
              ...
              <div className="project-item">
                ...
                <div className="project-content">
                  <div className="left-side-content">
                    ...
                    <span>Identifying core strengths
and opportunities.
Diagnose what you need</span>
                  </div>
              ...
              <div className="project-item">
                ...
                <div className="project-content">
                  <div className="left-side-content">
                    ...
                    <span>Provide guidance, advice,
feedback and support to
the team for business
success</span>
                  </div>
              ...
              <div className="project-item">
                ...
                <div className="project-content">
                  <div className="left-side-content">
                    ...
                    <span>We become the owner of
the Finance Function –
Founder can focus on core
business</span>
                  </div>
        ...
        <div className="row justify-content-center">
          <div className="col-lg-8">
            <div className="request-content text-center tg-heading-subheading animation-style3">
              <h2 className="title tg-element-title">
                Offering The Best Experience Of Business Consulting Services
              </h2>
              <div className="content-bottom">
                <a href="tel:992 061 9074" className="btn">
                  Request a Free Call
                </a>
          ...
          <div className="row justify-content-center">
            <div className="col-xl-3 col-lg-4 col-md-6 col-sm-8">
              <div className="team-item">
                ...
                <div className="team-content">
                  <h4 className="title">
                    <a href="team-details.html">Jone Cooper</a>
                  </h4>
            ...
            <div className="col-xl-3 col-lg-4 col-md-6 col-sm-8">
              <div className="team-item">
                ...
                <div className="team-content">
                  <h4 className="title">
                    <a href="team-details.html">Eleanor Pena</a>
                  </h4>
                  <span>Finance Advisor</span>
                </div>
              </div>
          ...
          <div className="col-xl-4 col-lg-6 col-md-10">
            <div className="blog-post-item shine-animate-item">
              <div className="blog-post-thumb">
                <a className="shine-animate" href="blog-details.html">
                  <img src="assets/img/blog/blog_post01.jpg" alt="" />
                </a>
                <a className="post-tag" href="blog.html">
                  Business
                </a>
              </div>
              <div className="blog-post-content">
                ...
                <div className="blog-avatar">
                  ...
                  <div className="avatar-content">
                    <p>
                      By <a href="blog-details.html">Doman Smith</a>
                    </p>
                  </div>
                </div>
